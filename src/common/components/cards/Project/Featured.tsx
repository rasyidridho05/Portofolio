      ...
      <div className="col-span-12 sm:col-span-7 relative ">
        <Link href={`${live}`}>
          <div className="h-[350px] w-full relative rounded-xl overflow-hidden">
            ...
            <div className="absolute top-0 bottom-0 left-0 right-0 bg-gray-900/50 transition-all duration-300 cursor-pointer hover:opacity-0" />
          </div>
        </Link>
      </div>
    );
    ...
    return (
      ...
      >
        <div>
          ...
          <h1 className="text-3xl font-medium text-gray-300"> {title} </h1>

          <div className="my-6 p-6 bg-[#3C3C3C] text-gray-300 shadow-xl rounded-xl hidden sm:block">
            <p> {description && description} </p>
          </div>

          <div
            className={cx(
              "flex text-gray-400 gap-x-4 justify-end flex-wrap",
          ...
          <div
            className={cx(
              "flex justify-end mt-5 gap-3 text-gray-300",
